import{_ as e,o as n,c as s,e as a}from"./app-D1PozkSp.js";const i={},l=a(`<h1 id="cmake" tabindex="-1"><a class="header-anchor" href="#cmake"><span>CMake</span></a></h1><p>最近在做C++的项目，而vscode我这里因为一些环境的问题，不太能搞，所以用了cmake这个工具来实现项目的编译运行</p><p>CMake的build需要我们先做一个CMakeLists.txt文件。我们结合我的实例来讲解。</p><h2 id="所有文件在同一目录下" tabindex="-1"><a class="header-anchor" href="#所有文件在同一目录下"><span>所有文件在同一目录下</span></a></h2><h3 id="文件结构" tabindex="-1"><a class="header-anchor" href="#文件结构"><span>文件结构</span></a></h3><p>这是我的项目情况</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>╰─❯ tree
