<template><div><h1 id="函数的参数传递" tabindex="-1"><a class="header-anchor" href="#函数的参数传递"><span>函数的参数传递</span></a></h1>
<h3 id="passing-by-value" tabindex="-1"><a class="header-anchor" href="#passing-by-value"><span>passing by value</span></a></h3>
<ul>
<li>这里传进去的其实是参数的一个copy，而不是参数本身，或者说是参数所对应的地址</li>
</ul>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">void</span> <span class="token function">func</span><span class="token punctuation">(</span><span class="token keyword">int</span> fa<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="passing-by-pointer" tabindex="-1"><a class="header-anchor" href="#passing-by-pointer"><span>passing by pointer</span></a></h3>
<ul>
<li>这个应该是很常见的</li>
</ul>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token comment">// 传入的参数是一个地址</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="passing-by-reference" tabindex="-1"><a class="header-anchor" href="#passing-by-reference"><span>passing by reference</span></a></h3>
<ul>
<li>先讲一下C++当中的reference，也就是引用。</li>
</ul>
<p>它有几个特点:</p>
<ol>
<li>可以将其理解成一个变量的别名</li>
</ol>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">int</span> original <span class="token operator">=</span> <span class="token number">100</span><span class="token punctuation">;</span>
...
<li>
<p>引用在定义时必须初始化，一旦与某个变量绑定，就无法再绑定到其它变量</p>
</li>
<li>
<p>引用在函数传参时尤其有用，因为它可以避免通过指针传参时可能发生的间接访问和解引用操作</p>
</li>
<li>
<p>引用在C++中提供了一种安全、便捷的替代指针的方式，尤其在函数传参、返回值和操作符重载时更能看到它的优势</p>
</li>
</ol>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">void</span> <span class="token function">func</span><span class="token punctuation">(</span><span class="token keyword">int</span> <span class="token operator">&amp;</span>fa<span class="token punctuation">)</span> <span class="token punctuation">{</span>
