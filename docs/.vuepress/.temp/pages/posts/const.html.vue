<template><div><h1 id="const" tabindex="-1"><a class="header-anchor" href="#const"><span>const</span></a></h1>
<p>讲讲C++当中<strong>const</strong>这个修饰符啊</p>
<h3 id="解释" tabindex="-1"><a class="header-anchor" href="#解释"><span>解释</span></a></h3>
...
<p>举几个例子:</p>
<ol>
<li><code v-pre>const int i</code> 在这个例子当中因为const的左边啥也没有，所以它指向了它右边的int，也就是说这个i变量是一个const int类型。</li>
<li><code v-pre>int* const i</code> 那么这里就修饰了它的左边，即这个指针。也就是说这个i变量是一个const的int指针，我们不能改变这个指针的指向。</li>
</ol>
...
<ol>
<li>
<p>若一个变量被修饰为const时，我们必须得在声明它的当时就直接对它进行分配赋值。</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token comment">// 错误</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token comment">// 正确</span>
...
<li>
<p>一个非const变量可以被赋值为const，反之则不行。</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token comment">// 错误</span>
<span class="token keyword">const</span> <span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token comment">// 正确</span>
...
<li>
<p>对于第二点，有一个比较tricky的点，特此提一下。</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">const</span> <span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里就要从const修饰的对象开始讲起了，先看左再看右，我们可以发现对于pi而言，它是一个指向const int的指针。所以pi的值是<strong>可以</strong>变化的，而且，不但可以指向cosnt int，甚至可以指向一个int，因为第二点说明了const可以是一个非const。</p>
</li>
</ol>
</li>
<li>
<p>const修饰函数:
一般来说在const修饰函数的过程会有三个常见的位置。</p>
<ol>
<li>
<p>const int function (int n) {}; :<br>
这里的情况代表了这个函数的返回值是一个const int，应该很好理解。</p>
</li>
<li>
<p>int function (const int n) {}; :<br>
这里的话就代表写入的这个参数n，我们在function()这个函数的实现当中，我们不能改变这个n，即使n它是一个非const。</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token comment">// 正确</span>
...
<li>
<p>int function (int n) const {}; :<br>
这个情况设计到了OOP，即Class这些面向对象的知识。<br>
当在类成员函数的声明和定义中的函数名后面加上const关键字，表明这个函数不会修改任何类成员变量，即使那些成员变量并没有被声明为const。</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">class</span> <span class="token class-name">MyClass</span> <span class="token punctuation">{</span>
...
<p>那么const除了防止我们改变它，还有其他的什么作用呢？</p>
<ol>
<li>类似于我们要尽量把Class当中的属性设高私密级，比如能用<code v-pre>private</code>就不用<code v-pre>protected</code>，能用<code v-pre>protected</code>就不用<code v-pre>public</code>，是一种符合安全性、规范性的写法。</li>
<li>使用const，可以使得我们的运行速度变快，因为运行的时候就不用想着“哎，这个变量要不要对它发生变化啊”诸如此类的疑问，所以速度会变快。</li>
</ol>
<p><s>这种作用一般不是我的强项，举不出来几个...太公式了，跟背书文科一样...大家应该能get到就行</s></p>
</div></template>
