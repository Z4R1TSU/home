<template><div><h1 id="std-thread" tabindex="-1"><a class="header-anchor" href="#std-thread"><span>std::thread</span></a></h1>
<p>C++的多线程绕不开C++-11当中的thread</p>
<p>传送门:</p>
<ol>
<li><a href="https://en.cppreference.com/w/cpp/thread/thread" target="_blank" rel="noopener noreferrer"><strong>thread</strong> in <em>cpp reference</em><ExternalLinkIcon/></a></li>
<li><a href="https://learn.microsoft.com/zh-cn/cpp/standard-library/thread?view=msvc-170" target="_blank" rel="noopener noreferrer"><strong>thread</strong> in <em>Microsoft Tutorial</em><ExternalLinkIcon/></a></li>
</ol>
<h2 id="创建线程" tabindex="-1"><a class="header-anchor" href="#创建线程"><span>创建线程</span></a></h2>
<h3 id="创建一个无参函数线程" tabindex="-1"><a class="header-anchor" href="#创建一个无参函数线程"><span>创建一个无参函数线程</span></a></h3>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;thread></span></span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="创建一个含参函数线程" tabindex="-1"><a class="header-anchor" href="#创建一个含参函数线程"><span>创建一个含参函数线程</span></a></h3>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;thread></span></span>
...
<span class="token keyword">int</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    t1<span class="token punctuation">.</span><span class="token function">join</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="创建一个类成员的含参函数线程" tabindex="-1"><a class="header-anchor" href="#创建一个类成员的含参函数线程"><span>创建一个类成员的含参函数线程</span></a></h3>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;thread></span></span>
...
<span class="token keyword">int</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    t1<span class="token punctuation">.</span><span class="token function">join</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="thread内部函数" tabindex="-1"><a class="header-anchor" href="#thread内部函数"><span>thread内部函数</span></a></h2>
<h3 id="get-id" tabindex="-1"><a class="header-anchor" href="#get-id"><span>get_id()</span></a></h3>
<p>线程存在着唯一标识符，而调用<code v-pre>get_id()</code>可以获取之。</p>
<p><code v-pre>int this_thread_id = std::this_thread::get_id();</code></p>
<h3 id="hardware-concurrency" tabindex="-1"><a class="header-anchor" href="#hardware-concurrency"><span>hardware_concurrency()</span></a></h3>
<p>可能有同学会疑惑，比如一个线程池，我们准备几个线程到线程池中合适呢？</p>
<p>答：一般几核CPU开几线程。</p>
<p>而获取核心数的办法是<code v-pre>std::thread::hardware_concurrency()</code></p>
<h3 id="join-重点" tabindex="-1"><a class="header-anchor" href="#join-重点"><span>join() (重点)</span></a></h3>
<p>等待线程，直到它执行完毕</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;iostream></span>     <span class="token comment">// for print</span></span>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token number">0</span> <span class="token number">1</span> <span class="token number">2</span> <span class="token number">3</span> <span class="token number">4</span> <span class="token number">5</span> <span class="token number">6</span> <span class="token number">7</span> <span class="token number">8</span> <span class="token number">9</span> <span class="token keyword">done</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="detach-重点" tabindex="-1"><a class="header-anchor" href="#detach-重点"><span>detach() (重点)</span></a></h3>
<blockquote>
<p>将线程分离（detach）操作的目的是使线程在后台运行，使得其执行变得独立，即允许线程在没有其他线程明确等待其完成的情况下结束。分离线程不会与创建它的线程同步，这意味着一旦分离，主线程将不再等待分离线程的结束。</p>
</blockquote>
<p>分离线程，在后台运行线程</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;iostream></span></span>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token keyword">done</span> <span class="token number">0</span> <span class="token number">1</span> <span class="token number">2</span> <span class="token number">3</span> <span class="token number">4</span> <span class="token number">5</span> <span class="token number">6</span> <span class="token number">7</span> <span class="token number">8</span> <span class="token number">9</span>
