...
<h3 id="move的原理" tabindex="-1"><a class="header-anchor" href="#move的原理"><span>move的原理</span></a></h3>
<p>比如说我这里有一个class My，它的组成是这样的</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">class</span> <span class="token class-name">My</span> <span class="token punctuation">{</span>
...
<p><img src="@source/public/images/images/std_move.png" alt="https://www.bilibili.com/video/BV1vT411X7JA/?spm_id_from=333.337.search-card.all.click&amp;vd_source=f53099189814dd887f4ab25638e07406"></p>
...
<h3 id="move的优点" tabindex="-1"><a class="header-anchor" href="#move的优点"><span>move的优点</span></a></h3>
<p>最后来聊聊move有什么让我们不得不去用它的理由</p>
<ol>
<li>减少不必要的数据复制，使得性能开销一定程度的减小，从而达到提高性能的作用</li>
</ol>
<p>(emmm可能我就只能列出这一项吧)</p>
</div></template>
